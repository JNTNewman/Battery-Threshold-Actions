...
#--------- BATTERY THRESHOLD ACTION INDICATOR ---------#
#													   #
    ...
    try:
        ...
        if(percentage >= ut and battery.power_plugged):
            ...
            notification.notify(
                ...
                message=str("Your battery is now @ {}%. Please unplug.".format(percentage)), app_icon="/mnt/LinuxData/DevEnv/python/btai@jnt.newman/btai/icons/battery-full.png",
                timeout=10)
            print('\a')
        elif(percentage <= lt and not battery.power_plugged):
            notification.notify(
                title="Battery Notification",
                message=str("Your battery is now @ {}%. Please charge.".format(percentage)), app_icon="/mnt/LinuxData/DevEnv/python/btai@jnt.newman/btai/icons/battery-empty.png",
                timeout=10)
            print('\007')
